...
from pydantic_agent.workflows.base import Workflow, WorkflowState, WorkflowStep
from pydantic_agent.workflows.errors import WorkflowMaxIterationsError
from pydantic_agent.workflows.react.config import ReActConfig
from pydantic_agent.workflows.react.hooks import ReActHooks
from pydantic_agent.workflows.react.prompts import (
    build_iteration_prompt,
    format_tool_call,
)
from pydantic_agent.workflows.react.state import ReActState
...
from pydantic_agent.workflows.react.tools import create_final_answer_tool
...
class ReActWorkflow(Workflow[DepsT, str, ReActState]):
    ...
    async def _maybe_compact(self, react_state: ReActState) -> None:
        ...
        threshold = self._react_config.compact_threshold_ratio * compaction_config.trigger_threshold_tokens
